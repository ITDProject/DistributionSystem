...
def agentRegistration (filename, N, Bus, InputFilesFolder, jsonFolderName):
	import json
	import re
	import os
	import shutil
	...
	path = os.path.join(InputFilesFolder,jsonFolderName)
...
#				print('  ended on', line)
	...
	for key, value in controllers.items(): # Process each controller
		...
		values = {}
		controllerDict['Dsystem'] = ['' for i in range(NDistSys)]
